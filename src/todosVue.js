const todosVue = {
  ...
  REGISTER_GCM_TOKEN_URL: 'http://todosbackend.manelgavalda.2dam.acacha.org/api/v1/user/gcmtoken',
  GET_MESSAGES_URL: 'http://todosbackend.manelgavalda.2dam.acacha.org/api/v1/user/messages'
}
